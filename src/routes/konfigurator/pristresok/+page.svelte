...
<KonfProduktStranka
	...
	nadpis="Navrhni si prístrešok alebo altánok"
	lead="Vyber typ, rozmery a vyhotovenie — pripravíme ti nezáväznú špecifikáciu (PDF) a ozveme sa s cenovou ponukou po obhliadke. Bez registrácie."
>
	{#snippet ovladacie()}
		<!-- TYP -->
	...
	{#snippet panel()}
		{#if suhrn}
			...
			<section class="kp-cena-info" data-testid="pristresok-cena-info">
				...
				<p>
					Prístrešok ti naceníme individuálne — pošli nezáväzný dopyt a pripravíme cenovú ponuku po
					obhliadke miesta.
				</p>
