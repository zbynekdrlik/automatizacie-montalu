...
export async function generateNarezakPdf(
	...
	// #528: QR zákazky (payload = holé sale.order.name) v pravom hornom rohu — rezač ho naskenuje
	// tabletom na Odoo kiosku a otvorí sa daná objednávka. Kreslí sa LEN keď je OP zadané (bez OP
	// ostáva výstup bez QR). Geometria zo zdieľaného pdf-common (rovnaká ako plán rezov / expedícia).
