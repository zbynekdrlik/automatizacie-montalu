...
// log so SNAPSHOTOM payloadu: každý import/release/reimport toho istého `content_hash` = NOVÝ riadok
...
// (Fable dizajn-konzult #5825). Odpis sa NIKDY nezahodí — žiaden poison-pill drop, žiaden časový
