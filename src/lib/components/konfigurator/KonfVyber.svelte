<script lang="ts">
	...
	// sem pridá svoj `/konfigurator/<slug>` literál (#385: pridaný bazén; #387: pridané zasklenie).
	type LiveRoute = '/konfigurator/pergola' | '/konfigurator/bazen' | '/konfigurator/zasklenie';
</script>
