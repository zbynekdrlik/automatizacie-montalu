<script lang="ts">
	...
	// sem pridá svoj `/konfigurator/<slug>` literál (#385: bazén, #390: prístrešky/altánky).
	type LiveRoute = '/konfigurator/pergola' | '/konfigurator/bazen' | '/konfigurator/pristresok';
</script>
