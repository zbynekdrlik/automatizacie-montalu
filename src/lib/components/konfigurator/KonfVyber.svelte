<script lang="ts">
	...
	// KONKRÉTNE interné route literály — jediné live rameno je pergola; každý produktový PR
	// (#385–#390), čo prepne kartu na `live`, sem pridá svoj `/konfigurator/<slug>` literál.
	type LiveRoute = '/konfigurator/pergola';
</script>
