...
// ČISTÝ, CLIENT-SAFE modul. BEZ interných Money kódov, BEZ ceny (cenu počíta server-only modul
// `konfigurator-zimna-zahrada-cena` z matice montalu.sk — tento klientsky modul cenu nenesie). Interná appka NEMÁ
