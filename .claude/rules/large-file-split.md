...
| `src/app.css` | ~891 | approaching — #376 redizajn rastie; PRED stage 3 (tabuľky/výsledky) zváž split: `@media print` blok → route-scoped/`print.css`, `nav.*` → vlastný súbor importovaný v `+layout.svelte` |
