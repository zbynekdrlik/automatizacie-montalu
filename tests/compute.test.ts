...
describe('computeFlat — 1:1 s overenými odpismi (Excel ground truth)', () => {
	...
	// (offsety 127,47/21/−65) → sklo bolo o pár mm vedľa. Správne: šírka 2x3K
	// (S+142,5)/6−83, 2x2K (S+40,6)/4−83; výška V−67−83. Sklo NIE je v Money odpise;
	// odpis (kódy + metre) sa touto opravou NEMENÍ (overené before/after).
	it('Slide opona: sklo 1:1 podľa Dominikovho Excelu (2026-07-23)', () => {
