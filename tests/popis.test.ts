...
describe('popisMulti — badge ťahá názov systému', () => {
	it('KĽÚČOVÉ: 3× Štandard + → „Štandard + · 3 posuvy" (nie „Zimná záhrada")', () => {
		const p = [
			{ system: 'Štandard +' },
			{ system: 'Štandard +' },
			{ system: 'Štandard +' }
		];
		expect(popisMulti(p)).toBe('Štandard + · 3 posuvy');
