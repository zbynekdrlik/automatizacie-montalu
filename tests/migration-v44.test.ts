// Reálny prod upgrade path v43 → v44: uložené plány rezov (#505).
// Postav DB v stave v43 (base tabuľky + ≥1 riadok → seedData/seedUsers no-opnú),
// import db.ts spustí SKUTOČNÝ v44 blok. Overuje: user_version=44, nová tabuľka +
// stĺpce + index, zapisovateľnosť, žiadna strata iných dát.
...
describe('migrácia v43 → v44: plan_rezov_ulozene (#505)', () => {
	it('user_version === 44 po migrácii', () => {
