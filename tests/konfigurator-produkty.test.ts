...
describe('KONF_PRODUKTY katalóg', () => {
	...
	it('pergola je PRVÁ a live; #385 bazén, #387 zasklenie, #389 tienenie ako live (ostatné „pripravujeme")', () => {
		...
		expect(live.map((p) => p.kod)).toEqual(['pergola', 'bazen', 'zasklenie', 'tienenie']);
	});
