...
describe('#385/#404/#408 cenový zdroj (honest-null gate)', () => {
	// rady s OVERENÝM interim cenníkom (matica montalu.sk): pergola (#279) + bazén (#404) + zimná záhrada (#408).
	const S_CENNIKOM = new Set(['pergola', 'bazen', 'zimna-zahrada']);

	it('pergola + bazén + zimná záhrada majú cenovyZdroj=true; zvyšné rady false', () => {
	...
	it('maCenovyZdroj: pergola+bazén+zimná záhrada true, ostatné false; NULL → true (v35 default); neznámy NEPRÁZDNY → false', () => {
