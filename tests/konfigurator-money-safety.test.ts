...
// #410: cenový modul oplotenia — nezávislá referencia MO/VO (+ zoznam cenových modelov) na overenie,
// že `vypocet` akcia oplotenia nesie MO, ale VO (veľkoobchod) je z verejnej odpovede ODSTRÁNENÝ.
import {
